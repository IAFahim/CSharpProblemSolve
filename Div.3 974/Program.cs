...
internal class A : ISolve
{
    public void Solve(StreamReader reader, StreamWriter writer)
    {
        ...
        for (int i = 0; i < t; i++)
        {
            ...
            int numberOfPeopleWhoWouldGetGold = NumberOfPeopleWhoWouldGetGold(n, k, a);
...
internal abstract class Template
{
    ...
    private const string ContestDirectory = @"D:\CSharpProblemSolve\Div.3 974";
